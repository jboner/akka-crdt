...
class RestServerSpec extends WordSpec with MustMatchers with BeforeAndAfterAll {
  ...
  "A CRDT REST server" must {
    ...
    "be able to create a new g-counter with a specific id" in {
      ...
      result must be("""{"type":"g-counter","id":"jonas","state":{}}""")
    }
    ...
    "be able to create a new g-counter with a random id" in {
      ...
      result.startsWith("""{"type":"g-counter"""") must be(true)
    }
    ...
    "be able to increment a g-counter" in {
      ...
      result must be("""{"type":"g-counter","id":"jonas","state":{"node1":1}}""")
    }
    ...
    "be able to update a g-counter JSON body" in {
      ...
      val result = Await.result(response, timeout).trim()
      result must be("""{"type":"g-counter","id":"jonas","state":{"node1":2}}""")
    }
    ...
    "be able to create a new pn-counter with a specific id" in {
      ...
      result must be("""{"type":"pn-counter","id":"users1","increments":{"type":"g-counter","id":"users1/inc","state":{}},"decrements":{"type":"g-counter","id":"users1/dec","state":{}}}""")
    }
    ...
    "be able to create a new pn-counter with a random id" in {
      ...
      result.startsWith("""{"type":"pn-counter"""") must be(true)
    }
    ...
    "be able to increment a pn-counter" in {
      ...
      val result = Await.result(response, timeout).trim()
      result must be("""{"type":"pn-counter","id":"users2","increments":{"type":"g-counter","id":"users2/inc","state":{"node1":1}},"decrements":{"type":"g-counter","id":"users2/dec","state":{}}}""")
    }
    ...
    "be able to decrement a pn-counter" in {
      ...
      val result = Await.result(response, timeout).trim()
      result must be("""{"type":"pn-counter","id":"users3","increments":{"type":"g-counter","id":"users3/inc","state":{}},"decrements":{"type":"g-counter","id":"users3/dec","state":{"node3":1}}}""")
    }
    ...
    "be able to update a pn-counter JSON body" in {
      ...
      val result = Await.result(response, timeout).trim()
      result must be("""{"type":"pn-counter","id":"users4","increments":{"type":"g-counter","id":"users4/inc","state":{"node1":2, "node2":1}},"decrements":{"type":"g-counter","id":"users4/dec","state":{"node1":1}}}""")
    }
